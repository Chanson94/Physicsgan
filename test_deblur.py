...
opt.model = 'cycle_gan_deblur'
opt.phase = 'test'
opt.dataset_mode = 'aligned_deblur_test'
opt.no_dropout = 'True'
opt.resize_or_crop = ''
opt.dataroot = './datasets/text_deblurring'
...
# plt.plot(range(1, len(psnr_all_epochs)+1), psnr_all_epochs, 'r', label = opt.name)
